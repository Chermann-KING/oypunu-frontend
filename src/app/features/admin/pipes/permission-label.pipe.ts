...
export class PermissionLabelPipe implements PipeTransform {
  ...
  private readonly permissionLabels: Record<Permission, string> = {
    ...
    [Permission.MANAGE_CATEGORIES]: 'Gérer les catégories',
    [Permission.CREATE_CATEGORIES]: 'Créer des catégories',
    [Permission.EDIT_CATEGORIES]: 'Modifier les catégories',
    [Permission.DELETE_CATEGORIES]: 'Supprimer les catégories',
    [Permission.VIEW_CATEGORIES]: 'Voir les catégories',
  ...
  private readonly permissionDescriptions: Record<Permission, string> = {
    ...
    [Permission.MANAGE_CATEGORIES]: 'Administrer les catégories de mots par langue',
    [Permission.CREATE_CATEGORIES]: 'Créer de nouvelles catégories pour organiser les mots',
    [Permission.EDIT_CATEGORIES]: 'Modifier les informations des catégories existantes',
    [Permission.DELETE_CATEGORIES]: 'Supprimer des catégories devenues obsolètes',
    [Permission.VIEW_CATEGORIES]: 'Consulter la liste des catégories et leurs détails',
